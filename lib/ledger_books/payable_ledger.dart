import 'package:final_project/model/payable.dart';
import 'package:flutter/material.dart';
import '../pages/ledger_books_page.dart';
import 'package:http/http.dart' as http;

class PayableLedger extends StatefulWidget {
  const PayableLedger({super.key});

  @override
  State<PayableLedger> createState() => _PayableLedgerState();
}

class _PayableLedgerState extends State<PayableLedger> {
  late List<Payable> _userModel = [];

  final String restApi = 'https://checking-tlhc.onrender.com/j/payable';
  ...
  Future<void> _getData() async {
    try {
      ...
      if (response.statusCode == 200) {
        setState(() {
          _userModel = Payable.usersFromJson(
